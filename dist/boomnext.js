...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndexDBVideos = __webpack_require__(7);
	...
	var App = function () {
		function App() {
			...
			try {
				...
				this.db = new _IndexDBVideos2.default();
			} catch (err) {
				this.gui.warn(err);
			}
			this.parsers = {
			...
			value: function nextVideo(skip) {
				...
				if (skip) {
					this.parser.getNext().then(function (video) {
						...
						_this4.video = video;
						return _this4.db.exists(video);
					}).then(function (exists) {
						_this4.message('video exists? ' + exists);
						if (exists) {
							_this4.nextVideo(true);
						} else {
							_this4.startVideo(_this4.video);
						}
					}, function (error) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@font-face {\n  font-family: 'Open Sans';\n  font-style: normal;\n  font-weight: 300;\n  src: local(\"Open Sans Light\"), local(\"OpenSans-Light\"), url(" + __webpack_require__(11) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Open Sans';\n  font-style: normal;\n  font-weight: 400;\n  src: local(\"Open Sans\"), local(\"OpenSans\"), url(" + __webpack_require__(12) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Open Sans';\n  font-style: normal;\n  font-weight: 600;\n  src: local(\"Open Sans Semibold\"), local(\"OpenSans-Semibold\"), url(" + __webpack_require__(13) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Open Sans';\n  font-style: normal;\n  font-weight: 700;\n  src: local(\"Open Sans Bold\"), local(\"OpenSans-Bold\"), url(" + __webpack_require__(14) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Open Sans';\n  font-style: normal;\n  font-weight: 800;\n  src: local(\"Open Sans Extrabold\"), local(\"OpenSans-Extrabold\"), url(" + __webpack_require__(15) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Open Sans';\n  font-style: italic;\n  font-weight: 300;\n  src: local(\"Open Sans Light Italic\"), local(\"OpenSansLight-Italic\"), url(" + __webpack_require__(16) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Open Sans';\n  font-style: italic;\n  font-weight: 400;\n  src: local(\"Open Sans Italic\"), local(\"OpenSans-Italic\"), url(" + __webpack_require__(17) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Open Sans';\n  font-style: italic;\n  font-weight: 600;\n  src: local(\"Open Sans Semibold Italic\"), local(\"OpenSans-SemiboldItalic\"), url(" + __webpack_require__(18) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Open Sans';\n  font-style: italic;\n  font-weight: 700;\n  src: local(\"Open Sans Bold Italic\"), local(\"OpenSans-BoldItalic\"), url(" + __webpack_require__(19) + ") format(\"truetype\"); }\n\n@font-face {\n  font-family: 'Open Sans';\n  font-style: italic;\n  font-weight: 800;\n  src: local(\"Open Sans Extrabold Italic\"), local(\"OpenSans-ExtraboldItalic\"), url(" + __webpack_require__(20) + ") format(\"truetype\"); }\n\nbody {\n  position: relative;\n  background-size: cover;\n  margin: 0;\n  font-family: 'Open Sans', sans-serif;\n  color: #fff;\n  font-weight: 300;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center; }\n\nheader {\n  background: rgba(255, 255, 255, 0.4);\n  height: 56px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  width: 100%;\n  position: relative; }\n  header h1 {\n    font-weight: normal; }\n\n.menu {\n  position: absolute;\n  top: 0;\n  left: 0;\n  cursor: pointer;\n  text-align: center;\n  line-height: 56px;\n  height: 56px;\n  width: 56px;\n  font-size: 2.5em; }\n\n.overlay {\n  display: none;\n  position: absolute;\n  top: 0;\n  left: 0;\n  background: rgba(0, 0, 0, 0.95);\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  color: #fff;\n  width: 100%;\n  height: 100%;\n  z-index: 3; }\n  .overlay a {\n    color: #fff; }\n    .overlay a:hover, .overlay a:visited {\n      color: #fff; }\n  .overlay .close {\n    position: absolute;\n    top: 0;\n    right: 0;\n    width: 50px;\n    height: 50px;\n    line-height: 50px;\n    font-size: 3em; }\n  .overlay .body {\n    font-size: 2em;\n    max-width: 600px; }\n  .overlay table {\n    font-size: 2em; }\n    .overlay table thead td {\n      font-weight: bold;\n      padding-bottom: 14px; }\n    .overlay table td {\n      min-width: 200px; }\n\nnav {\n  position: absolute;\n  background: rgba(0, 0, 0, 0.5);\n  width: 300px;\n  margin-left: -300px;\n  height: 100%;\n  top: 0;\n  left: 0;\n  padding-top: 84px;\n  -webkit-transition: all 250ms;\n  transition: all 250ms; }\n  nav ul {\n    padding: 0;\n    list-style: none;\n    width: 100%; }\n    nav ul li {\n      height: 56px;\n      width: 100%;\n      font-size: 2.5em;\n      padding-left: 56px;\n      cursor: pointer;\n      display: -webkit-box;\n      display: -ms-flexbox;\n      display: flex;\n      -webkit-box-align: center;\n          -ms-flex-align: center;\n              align-items: center; }\n  nav.extended {\n    margin-left: 0; }\n\n.upload-plugin {\n  display: none; }\n  .upload-plugin + label {\n    width: 200px;\n    height: 50px;\n    background: #2DA7EF;\n    color: #fff;\n    border-radius: 3px;\n    display: -webkit-inline-box;\n    display: -ms-inline-flexbox;\n    display: inline-flex;\n    -webkit-box-pack: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n    cursor: pointer; }\n\n.icon-info {\n  display: inline-block;\n  width: 18px;\n  height: 18px;\n  border-radius: 50%;\n  border: 2px solid #fff;\n  font-style: italic;\n  font-size: 16px;\n  text-align: center;\n  line-height: 20px;\n  font-weight: 700;\n  margin-left: 2px;\n  margin-right: 12px; }\n\n.docu td {\n  min-width: 100px; }\n\n.docu .larger {\n  font-size: 1.4em; }\n\n.boom {\n  display: inline-block;\n  -webkit-transform: scaleX(-1) rotate(12deg);\n          transform: scaleX(-1) rotate(12deg); }\n\n.greeting {\n  font-size: 72px;\n  margin: 28px;\n  text-align: center; }\n\n.sub-greeting {\n  font-size: 2.5em;\n  text-align: center; }\n\n.stations {\n  margin-top: 28px;\n  max-width: 681px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-wrap: wrap;\n      flex-wrap: wrap;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center; }\n  .stations div {\n    width: 220px;\n    height: 130px;\n    margin: 3.5px;\n    border-radius: 3px;\n    background: rgba(0, 0, 0, 0.5);\n    color: #fff;\n    box-sizing: border-box;\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n    -webkit-box-pack: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    cursor: pointer;\n    -webkit-transition: all 250ms;\n    transition: all 250ms; }\n    .stations div:hover {\n      background: rgba(0, 0, 0, 0.9); }\n\n.tv-overlay {\n  position: fixed;\n  background-color: rgba(0, 0, 0, 0.9);\n  z-index: 2;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  top: 0;\n  left: 0; }\n  .tv-overlay .loading {\n    position: absolute;\n    left: 50%;\n    right: 50%;\n    top: 50%;\n    bottom: 50%;\n    font-size: 22px;\n    color: #d23c22;\n    white-space: nowrap; }\n  .tv-overlay webview {\n    display: none; }\n  .tv-overlay video {\n    display: none; }\n\n.status {\n  position: absolute;\n  z-index: 3;\n  right: 0;\n  bottom: 0;\n  color: #eee; }\n\n.warn {\n  position: absolute;\n  z-index: 3;\n  width: 100%;\n  top: 14px;\n  left: 0;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column; }\n  .warn > div {\n    position: relative;\n    width: 340px;\n    padding: 14px;\n    font-size: 1.2em;\n    font-weight: 400;\n    background: #d0021b;\n    color: #fff;\n    border-radius: 3px;\n    margin-bottom: 7px;\n    padding-right: 14px; }\n    .warn > div .close {\n      position: absolute;\n      width: 30px;\n      height: 30px;\n      line-height: 30px;\n      cursor: pointer;\n      top: 0;\n      right: 0;\n      display: -webkit-box;\n      display: -ms-flexbox;\n      display: flex;\n      -webkit-box-pack: center;\n          -ms-flex-pack: center;\n              justify-content: center;\n      -ms-flex-line-pack: center;\n          align-content: center;\n      font-size: 1.6em; }\n\n.tv-next,\n.tv-next-skip,\n.tv-prev {\n  font-size: 120px;\n  color: #eee;\n  position: absolute;\n  top: 0;\n  width: 75px;\n  height: 100%;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  cursor: pointer; }\n  .tv-next:hover,\n  .tv-next-skip:hover,\n  .tv-prev:hover {\n    color: #d23c22; }\n\n.tv-next {\n  right: 78;\n  -webkit-box-pack: end;\n      -ms-flex-pack: end;\n          justify-content: flex-end; }\n\n.tv-next-skip {\n  right: 0;\n  -webkit-box-pack: end;\n      -ms-flex-pack: end;\n          justify-content: flex-end; }\n\n.tv-prev {\n  left: 0;\n  -webkit-box-pack: start;\n      -ms-flex-pack: start;\n          justify-content: flex-start; }\n\n.tv-control {\n  position: fixed;\n  z-index: 3;\n  top: 5px;\n  right: 5px;\n  color: #CA4343;\n  border-radius: 5px;\n  width: 70px;\n  height: 40px;\n  background: rgba(0, 0, 0, 0.3);\n  padding: 3px 5px;\n  cursor: pointer;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center; }\n", ""]);
